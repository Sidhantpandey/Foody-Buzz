...
const PlaceOder = () => {
  ...
  // creating a state variable where we store Information from the form 
...
// a handler to update the state variable 
...
// we will be writing placeorder function which will redirect us to the payment gateway 
